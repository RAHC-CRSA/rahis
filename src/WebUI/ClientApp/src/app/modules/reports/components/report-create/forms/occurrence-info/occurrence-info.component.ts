...
import { loadOccurrences } from 'src/app/views/reports/store/actions';
import { getOccurrences } from 'src/app/views/reports/store/reducers';
import { OccurrenceDto } from 'src/app/web-api-client';

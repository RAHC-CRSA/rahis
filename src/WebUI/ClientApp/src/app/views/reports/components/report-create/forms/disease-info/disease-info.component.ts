...
import { loadDiseases, loadSpecies } from 'src/app/views/reports/store/actions';
import { getDiseases, getSpecies } from 'src/app/views/reports/store/reducers';
import { DiseaseDto, SpeciesDto } from 'src/app/web-api-client';

...
namespace RegionalAnimalHealth.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230406164542_CreateAppEntities")]
    partial class CreateAppEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RegionalAnimalHealth.Domain.Entities.Reports.Occurrence", b =>
                {
                    ...
                    b.Property<long>("InitialReportId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RegionalAnimalHealth.Domain.Entities.Reports.Report", b =>
                {
                    ...
                    b.Property<bool>("DesctructionOfCorpses")
                        .HasColumnType("bit");

                    b.Property<long>("DiagnosticTestId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("NumberAffected")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RegionalAnimalHealth.Domain.Entities.Reports.Occurrence", b =>
                {
                    b.HasOne("RegionalAnimalHealth.Domain.Entities.Reports.Report", "InitialReport")
                        .WithMany()

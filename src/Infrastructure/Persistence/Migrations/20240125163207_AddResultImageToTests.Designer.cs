...
namespace RegionalAnimalHealth.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240125163207_AddResultImageToTests")]
    partial class AddResultImageToTests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RegionalAnimalHealth.Domain.Entities.Reports.ControlMeasure", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RegionalAnimalHealth.Domain.Entities.Reports.DiagnosticTest", b =>
                {
                    ...
                    b.Property<string>("TestResultImage")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RegionalAnimalHealth.Domain.Entities.Reports.File", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RegionalAnimalHealth.Domain.Entities.Reports.Report", b =>
                {
                    ...
                    b.Property<long?>("ControlMeasureId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RegionalAnimalHealth.Domain.Entities.Reports.Report", b =>
                {
                    b.HasOne("RegionalAnimalHealth.Domain.Entities.Reports.ControlMeasure", "ControlMeasure")
                        .WithMany()

...
namespace RegionalAnimalHealth.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230517045705_RenameAffectedToInfectedOnReports")]
    partial class RenameAffectedToInfectedOnReports
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RegionalAnimalHealth.Domain.Entities.Reports.DiagnosticTest", b =>
                {
                    ...
                    b.Property<long>("DiagnosticTestTypeId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RegionalAnimalHealth.Domain.Entities.Reports.DiagnosticTestType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("DiagnosticTestTypes", (string)null);
                });
            ...
            modelBuilder.Entity("RegionalAnimalHealth.Domain.Entities.Reports.Report", b =>
                {
                    ...
                    b.Property<long>("Mortality")
                        .HasColumnType("bigint");

                    b.Property<bool>("MovementControl")
                        .HasColumnType("bit");

                    b.Property<long>("NumberExposed")
                        .HasColumnType("bigint");

                    b.Property<long>("NumberInfected")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RegionalAnimalHealth.Domain.Entities.Reports.VaccinationType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RegionalAnimalHealth.Domain.Entities.Reports.Report", b =>
                {
                    ...
                    b.HasOne("RegionalAnimalHealth.Domain.Entities.Reports.Occurrence", null)
                        .WithMany("Reports")

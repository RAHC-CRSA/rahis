...
{
    /// <inheritdoc />
    public partial class CreateAppEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Zoonotic = table.Column<bool>(type: "bit", nullable: false),
                    Code = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParaProfessionals", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberTested = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DiagnosticTests_ParaProfessionals_ProfessionalId",
                        column: x => x.ProfessionalId,
                        principalTable: "ParaProfessionals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NumberVaccinated = table.Column<int>(type: "int", nullable: false),
                    ReportId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Vaccinations_ParaProfessionals_ProfessionalId",
                        column: x => x.ProfessionalId,
                        principalTable: "ParaProfessionals",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateEnded = table.Column<DateTime>(type: "date", nullable: false),
                    IsOngoing = table.Column<bool>(type: "bit", nullable: false),
                    IsVerified = table.Column<bool>(type: "bit", nullable: false),
                    Mortality = table.Column<long>(type: "bigint", nullable: false),
                    ReportType = table.Column<int>(type: "int", nullable: false),
                    Longitude = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Latitude = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DesctructionOfCorpses = table.Column<bool>(type: "bit", nullable: false),
                    Disinfection = table.Column<bool>(type: "bit", nullable: false),
                    Observation = table.Column<bool>(type: "bit", nullable: false),
                    Quarantine = table.Column<bool>(type: "bit", nullable: false),
                    MovementControl = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reports_Occurrences_OccurrenceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiagnosticTests_ProfessionalId",
                table: "DiagnosticTests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vaccinations_ProfessionalId",
                table: "Vaccinations",
                column: "ProfessionalId");
        }
